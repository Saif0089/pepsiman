...
{
	Material.PreshaderBuffer[0] = float4(0.000000,-0.100000,30.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.500000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.500000,0.000000,0.000000,0.000000);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local7 = (Local5.rgb * ((MaterialFloat3)Material.PreshaderBuffer[0].z));
	...
	PixelMaterialInputs.Roughness = Material.PreshaderBuffer[2].y;
