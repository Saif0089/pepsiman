...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.000000,0.451376,0.135354,40.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.000000,0.500000,1.000000,0.000000);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local6 = (Material.PreshaderBuffer[1].xyz * Local5);
	MaterialFloat3 Local7 = (Local6 * ((MaterialFloat3)Material.PreshaderBuffer[1].w));
	...
	PixelMaterialInputs.Metallic = Material.PreshaderBuffer[3].x;
	PixelMaterialInputs.Specular = Material.PreshaderBuffer[3].y;
	PixelMaterialInputs.Roughness = Material.PreshaderBuffer[3].z;
