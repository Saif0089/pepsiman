...
{
	Material.PreshaderBuffer[0] = float4(1.000000,20.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[1] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.PreshaderBuffer[2] = float4(0.541667,0.541667,0.541667,0.000000);//(Unknown)
	Material.PreshaderBuffer[3] = float4(0.500000,1.000000,0.000000,0.000000);//(Unknown)
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat Local5 = (Local3.r * Material.PreshaderBuffer[0].y);
	MaterialFloat Local6 = (Local3.g * Material.PreshaderBuffer[0].y);

	// The Normal is a special case as it might have its own expressions and also be used to calculate other inputs, so perform the assignment here
	PixelMaterialInputs.Normal = MaterialFloat3(MaterialFloat2(Local5,Local6),Local3.b);
...
SHADER_DISABLE_WARNINGS
	...
	MaterialFloat3 Local7 = lerp(((MaterialFloat3)0.00000000),Material.PreshaderBuffer[1].xyz,Material.PreshaderBuffer[0].z);
	MaterialFloat Local8 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local1), 0);
	MaterialFloat4 Local9 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1,samplerMaterial_Texture2D_1,DERIV_BASE_VALUE(Local1),View.MaterialTextureMipBias));
